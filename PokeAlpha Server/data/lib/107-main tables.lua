...
base_Fome_e_Felicidade = 60 -- o Maximo � 150. Quando for capturado ou criado pelo god. 60 = normal

---Efeitos
EFFECT_DIG = 88
EFFECT_CUT = 93
--- Msgs
MSG_NAO_E_POSSIVEL = "Desculpe, mas isso n�o � poss�vel."
...
["Brock"] = {article = "Ele �", description = "l�der do gin�sio de Pewter"},
["Misty"] = {article = "Ela �", description = "l�der do gin�sio de Cerulean"},
["Surge"] = {article = "Ele �", description = "l�der do gin�sio de Vermilion"},
["Erika"] = {article = "Ela �", description = "l�der do gin�sio de Celadon"},
["Sabrina"] = {article = "Ela �", description = "l�der do gin�sio de Saffron"},
["Koga"] = {article = "Ele �", description = "l�der do gin�sio de Fuchsia"},
["Blaine"] = {article = "Ele �", description = "l�der do gin�sio de Cinnabar"},
["Giovanni"] = {article = "Ele �", description = "l�der do gin�sio de Viridian"},
}
...
storages = {  -- Todas as storages usadas em quaisquer scripts ter�o q ser armazenadas aqui
        iconSys = 20000,
        pokedexSys = 8052,
		playerClan = 8053,
		playerClanRank = 8054,
