...
local doors = {15226, 15225, 15224, 15223}
local door_pos = {x = 1024, y = 1030, z = 7}



-- FIM CONFIGURAÇÕES --
local top_left = {x = door_pos.x - 3, y = door_pos.y - 1, z = door_pos.z}
local bottom_right = {x = door_pos.x, y = door_pos.y + 1, z = door_pos.z}
