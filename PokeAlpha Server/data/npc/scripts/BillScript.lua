...
selfSay("Ok, I'm already almost done my research officer clans, int�o I need you to talk to ash he will speak to the attribute needed to finalize the clan, can you bring me this Feedback from the ash?", cid)
talkState[talkUser] = 3
elseif (msgcontains(msg, 'yes') or msgcontains(msg, 'sim')) and talkState[talkUser] == 2 then
